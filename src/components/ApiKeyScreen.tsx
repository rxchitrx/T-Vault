      ...
      <div className="w-full max-w-md mx-4">
        <div className="card p-10 animate-fadeIn">
          ...
          <div className="text-center mb-10 animate-fadeIn">
            ...
            <h1 className="text-3xl font-semibold text-gray-900 dark:text-white mb-2 tracking-tight animate-slideUp" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
              Welcome to T-Vault
            </h1>
            <p className="text-sm text-gray-500 dark:text-zinc-500 animate-slideUp" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
              First, let's set up your Telegram API credentials
            </p>
          </div>

          {/* Instructions */}
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30 rounded-xl animate-fadeIn" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
            <div className="flex items-start space-x-3">
              <ExternalLink className="w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-blue-900 dark:text-blue-400 mb-1">Get Your API Credentials</p>
                <ol className="text-xs text-blue-700 dark:text-blue-300 space-y-1 list-decimal list-inside">
                  ...
                  <li>Copy your <code className="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">api_id</code> and <code className="bg-blue-100 dark:bg-blue-900/50 px-1 rounded">api_hash</code></li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 animate-fadeIn" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
            {/* API ID */}
            <div>
              <label htmlFor="apiId" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                API ID
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <KeyRound className="h-5 w-5 text-gray-400 dark:text-zinc-600" />
                </div>
                <input
                  id="apiId"
                  type="text"
            ...
            {/* API Hash */}
            <div>
              <label htmlFor="apiHash" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                API Hash
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          {/* Footer Note */}
          <p className="mt-6 text-xs text-center text-gray-500 dark:text-zinc-600 animate-fadeIn" style={{ animationDelay: '0.5s', animationFillMode: 'both' }}>
